  ...
  <div id="page">
    ...
    <div class="page-content">
      ...
      <div class="page-title page-title-small">
        <h2><a href="index.php?fix=no"><i class="fa fa-arrow-left"></i></a>Update info</h2>
...
permit
    */
        ...
        $sql = " UPDATE establishment SET permit='$file_name2', name='$name', establishment_description = '$establishment_description', lat='$lat', lng='$lng', category = '$category', cuisine_type ='$cuisine_type', image ='$file_name', tags='$tags' where id = '$id'";
        ...
        if (mysqli_query($conn, $sql)) {
          ...
          echo ' <div class="alert mr-3 ml-3 mt-n3 rounded-s bg-green1-dark" role="alert">
            <span class="alert-icon"><i class="fa fa-check-circle font-18"></i></span>
            <h4 class="text-uppercase color-white">Update Success</h4>
            <strong class="alert-icon-text">Your Establishment information updated</strong>
            <button type="button" class="close color-white opacity-60 font-16" data-dismiss="alert" aria-label="Close">&times;</button>
        </div> 
    ...
    ';
      ...
      <div class="card card-style">
        <div class="content mb-0">
          ...
          <div id="toast-5" class="toast toast-tiny toast-bottom bg-blue2-dark" data-delay="300000" data-autohide="true"><i class="fa fa-sync fa-spin mr-3"></i>Processing...</div>
          <h1 class="font-700 mb-0">Update Establishment</h1>
          <p class="font-11  mt-n1 mb-1">
            Update of establishment below.
          </p>




          <form action="edit_estab.php" method="post" enctype="multipart/form-data">
            ...
            include "database.php";
            $sql = "SELECT * FROM establishment where id ='" . $_GET['estab_id'] . "' and status=1 ";
            $result = $conn->query($sql);
            ...
            if ($result->num_rows > 0) {
              ...
              while ($row = $result->fetch_assoc()) {
                echo '
                                     ...
                                     <input type="hidden" name="id" value="' . $row['id'] . '" required placeholder="Description">
            ...
            <div class="input-style mt-2 has-icon input-style-1 input-required">
                ...
                <em>(required)</em>
                <input type="name" name="name" id="name2" value="' . $row['name'] . '" required placeholder="Name of Establishment">
            </div> 
            <div class="input-style has-icon input-style-1 input-required">
                <i class="input-icon fa fa-info-circle color-blue2-dark"></i>
                <span>Description</span>
                <em>(required)</em>
                <input type="name" name="establishment_description" value="' . $row['establishment_description'] . '" required placeholder="Description">
            </div>
...
#map {
  ...
  <input style="display:none;"  type="text" id="la" name="lat" value="' . $row['lat'] . '">  <input style="display:none;" type="text" id="lo" name="lng" value="' . $row['lng'] . '">
            ...
            <div class="input-style input-style-1 input-required">
             ...
             <div class="input-style input-style-1 input-required">
                    ...
                    <select class="form-control" required name="cuisine_type"  >
                        <option disabled selected  >' . $row['cuisine_type'] . '</option>
            ...
            <div class="input-style has-icon input-style-1 input-required">
                ...
                <span>Tags</span>
                <em>(required)</em>
                <input type="name" name="tags" value="' . $row['tags'] . '" required placeholder="Search hints, food, place etc.">
            </div> 
   ...
   ';
            ...
            <br>
            <button type="submit" name="update2" class="float-left mr-2 ml-1 btn btn-s bg-blue2-dark rounded-xl shadow-xl text-uppercase mb-3  btn-full   mt-5"><i class="fa fa-upload color-success"></i> Update</button>
          </form>
    ...
    <!---------------->
    <!---------------->
    <div id="add-food" class="menu menu-box-bottom menu-box-detached rounded-m" data-menu-height="420" data-menu-effect="menu-over">
      <div class="content mb-0">
        <div id="toast-1" class="toast toast-tiny toast-top bg-blue2-dark" data-delay="300000" data-autohide="true"><i class="fa fa-sync fa-spin mr-3"></i>Processing...</div>
