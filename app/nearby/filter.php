...
<form  style="display: none;"  action="route.php" method="get">
  Latitude <input type="text" id="la" name="latitude" value="<?php echo $_GET['lat']; ?>"> Longitude<input type="text" id="lo" name="longtitude" value="<?php echo $_GET['lng']; ?>"><br>
...
?>
          ...
          <input style="display:none;" type="text" id="mylocation1"  name="lat" value="<?php echo $_GET['lat']; ?>"> <input style="display:none;" type="text"  id="mylocation2"  name="lng" value="<?php echo $_GET['lng']; ?>"><br>
            </form>
        </div>
         </div>
        ...
        <div class="mr-3 ml-3 mt-3">
            ...
            <p class="font-11  mt-n1 mb-2">
                Please Select Distance filter below.
                  <a href="#" style="display: none;" id="submit2" data-toast="toast-1">
...
$sql = "SELECT *  FROM establishment order by id DESC ";
$result = $conn->query($sql);
...
$id = $row['id'];
    echo '
         <div style="display:none;">   establishment '.$row['id'].' : <input type="text" name="lat" value="'.$row['lat'].', '.$row['lng'].'"> <br>
 </div>
    ';
...
?>
        ...
        <div class="input-style input-style-2 input-required">
          ...
          <button  type="submit" onclick="submit3()"  name="submit"  class="btn btn-m btn-full rounded-sm shadow-l bg-green1-dark text-uppercase font-900">Save</button>  
  </form>
        </div>
    </div>     
...
$sql = "SELECT * FROM establishment where status = '1' and (distance < '".$_GET['distance']."') ";
$result = $conn->query($sql);
...
var  marker = new google.maps.Marker({
  ...
  var circle = {
        ...
        fillColor: "#c3fc49",
        fillOpacity: 0.15,
            radius: <?php echo $_GET['distance']; ?> * 1000 // in km
        };
