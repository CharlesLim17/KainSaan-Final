 ...
 <body class="theme-light" data-highlight="yellow2">
   ...
   <div id="page">
     ...
     <div id="footer-bar" class="footer-bar-1  ">
       ...
       <a href="#" onclick="notif()"><i class="fa fa-bell"></i><span>notification</span>
     ...
     <div class="page-content">
       ...
       <button data-menu="menu-confirm" style="font-size: 20;" href="#" class="btn btn-3d btn-s ml-3 f mt-2 rounded-0 text-uppercase font-900 shadow-s border-blue1-dark bg-blue1-light"><i class="fa fa-map-marker-alt font-20"></i></button>
       ...
       <div>
         ...
         <form style="display: none;" action="route.php" method="get">
           Latitude <input type="text" id="la" name="latitude" value="14.598253721915198"> Longitude<input type="text" id="lo" name="longtitude" value="121.01262904665623"><br>
...
<br>
     ...
     <div id="menu-main" class="menu menu-box-right menu-box-detached rounded-m" data-menu-width="260" data-menu-load="menu-main.php" data-menu-active="nav-welcome" data-menu-effect="menu-over">
     </div>
     ...
     <!---------------->
     <!---------------->
     <div style="display: none;" id="menu-confirm" class="menu menu-box-bottom menu-box-detached rounded-m" data-menu-height="150" data-menu-effect="menu-over">
       ...
       <form method="get" action="mylocation.php">
         <input type="text" style="display: none;" id="mylocation01" name="latitude" value="14.598253721915198"> <input style="display: none;" type="text" id="mylocation02" name="longtitude" value="121.01262904665623">
         <div class="row mr-3 ml-3 ">
           <div class="col-6">
             <a href="#" onclick="allow()" class="close-menu btn btn-sm btn-full button-s shadow-l rounded-s text-uppercase font-900 bg-green1-dark">Allow</a>
             <a style="display: none;" href="#" id="fix" class="close-menu  "></a>
           </div>
           <button style="display: none;" id="allow" type="submit"></button>
       </form>
       <div class="col-6">
   ...
   <div id="direction" class="menu menu-box-modal rounded-m" data-menu-height="220" data-menu-width="80%" data-menu-effect="menu-over">
  ...
  <option  value="' . $row['lat'] . ', ' . $row['lng'] . '">' . $row['name'] . '</option>
   ...
   ';
         ...
         <button type="submit" onclick="calcRoute();" name="submit" id="submit" class="btn btn-m btn-full rounded-sm shadow-l bg-green1-dark text-uppercase font-900">Get Directions</button>
         <input style="display:none;" type="text" id="mylocation1" name="lat" value="14.598253721915198"> <input style="display:none;" type="text" id="mylocation2" name="lng" value="121.01262904665623"><br>
       </form>
     </div>
   </div>
   ...
   <!---------------->
   <!---------------->
   <div id="distance" class="menu menu-box-modal rounded-m" data-menu-height="250" data-menu-width="310">
     <div class="mr-3 ml-3 mt-3">
       ...
       <form method="get" action="calculate.php">
         <input style="display:none;" type="text" id="mylocation001" name="lat" value="14.598253721915198"> <input style="display:none;" type="text" id="mylocation002" name="lng" value="121.01262904665623"><br>
