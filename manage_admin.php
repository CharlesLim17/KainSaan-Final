...
<div class="page-heading">
    <h3>Manage Admin</h3>
 <div class="float-end"><a href="#" class="btn float-right icon icon-left btn-success" data-bs-toggle="modal"
                                            data-bs-target="#add_admin"><i data-feather="check-circle"></i>
                                Add Admin</a></div><br>
    </div>
...
if ($result->num_rows > 0) {
  ...
  while($row = $result->fetch_assoc()) {
    echo '
                           ...
                           <td><h5><span class="badge bg-info">'.$row['type'].'</span></h5></td>
                                            ...
                                            <div class="modal-dialog modal-md modal-dialog-centered modal-dialog-scrollable"
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-header bg-info">
                                                        <h5 class="modal-title white" id="myModalLabel130">Update Admin information
                                                        </h5>
                                            ...
                                            <div class="form-group has-icon-left">
                                                ...
                                                <div class="position-relative">
                                                    <input type="text" class="form-control" name="username"
                                                        placeholder="Username" value="'.$row['username'].'" id="username-icon">
                                                    <div class="form-control-icon">
                                                        <i class="bi bi-person"></i>
                                                    </div>
                                                </div>
...
?>
    ...
    <!-- Basic Tables end -->
      ...
      <!--info theme Modal -->
                                        <div class="modal fade text-left" id="add_admin" tabindex="-1" role="dialog"
                                            aria-labelledby="myModalLabel130" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable"
                                                role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header bg-success">
                                                        <h5 class="modal-title white" id="myModalLabel130">Add Admin
                                                        </h5>
                                                        <button type="button" class="close" data-bs-dismiss="modal"
                                                            aria-label="Close">
                                                            <i data-feather="x"></i>
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group has-icon-left">
                                                ...
                                                <div class="position-relative">
                                                    <input type="text" class="form-control" name="fullname"
                                                        placeholder="Fullname"  id="fullname-icon">
                                                    <div class="form-control-icon">
                                                        <i class="bi bi-person"></i>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-12">
                                            <div class="form-group has-icon-left">
                                                ...
                                                <div class="position-relative">
                                                    <input type="text" class="form-control" name="username"
                                                        placeholder="Username"  id="username-icon">
                                                    <div class="form-control-icon">
                                                        <i class="bi bi-person"></i>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-group has-icon-left">
                                                ...
                                                <div class="position-relative">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <button type="submit" name="add" class="btn btn-success ml-1">
                                                            <i class="bx bx-check d-block d-sm-none"></i>
                                                            <span class="d-none d-sm-block"><i data-feather="check-square"></i> Save</span>
                                                        </button>
                                                    </div>
                                                </div>
                                            </div>
...
$sql = "UPDATE admin SET fullname = '$fullname', email = '$email', phone ='$phone' WHERE id='$admin_id' ";

if (mysqli_query($conn, $sql)) {
   echo'<script>alert(" You   Successfully Updated Admin info")
...
if (mysqli_query($conn, $sql)) {
   echo'<script>alert(" You   Successfully deleted Admin info")
            window.location="manage_admin.php"
            </script>';
...
$sql = "INSERT INTO admin (fullname, username, email, phone, password)
VALUES ('$fullname', '$username', '$email', '$phone', '$password')";

if (mysqli_query($conn, $sql)) {
   echo'<script>alert(" You   Successfully Add Admin info")
            window.location="manage_admin.php"
            </script>';
